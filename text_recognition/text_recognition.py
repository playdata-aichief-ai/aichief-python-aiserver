...
class Text_Recognition():
    ...
    def __init__(self, Transformation='TPS', FeatureExtraction='ResNet', SequenceModeling='BiLSTM', Prediction='Attn', saved_model=os.path.join(BASE_DIR, 'text_recognition', 'saved_models', 'the_best_accuracy.pth')):  # _lenplus_66
